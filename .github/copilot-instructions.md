...
- **Baseline result (Glasgow / Southern Scotland, whole-system, 10 kWh, derived 5p/kWh deg cost, £15,360 capex).** Data year **2025** for tariffs + demand; PV is 2023 (only year available), aligned positionally. Headline whole-system counterfactual = **grid-only on the flat tariff (26.42p)**; **run-to-fade** is the baseline replacement policy (0.60 SOH floor, warranty-residual credit); forced-10-year replacement is a conservative sensitivity. Tariff-axis **run-to-fade NPVs: Agile −£4,040 (BCR 0.784) > E7 −£5,292 (0.722) > Flat −£6,700 (0.641)** — none viable, Agile closest. Headline annual savings: flat £749, E7 £940, Agile £940. E7 and Agile give near-identical savings but Agile's NPV is better (E7 cycles the battery harder → replacement year 16 vs 18). Forced-10yr sensitivity NPVs: flat −£10,002, E7/Agile ≈ −£7,206. Same-tariff grid-only is reported as a decomposition (tariff-switch effect vs PV-BESS hardware value). **NPV, not payback, is the headline viability metric.**
