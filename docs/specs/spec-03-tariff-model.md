...
evolves. Framing: whole-system, derived degradation penalty, headline counterfactual =
grid-only on the flat tariff (26.42 p/kWh), **run-to-fade** replacement policy. Metrics
reported separately.

> **Superseded (capex overhaul, 2026-07-21):** the table below was recorded under the
> retired £15,360 whole-system capex (£600/kWh battery, £1,940/kWp PV) and derived 5 p/kWh
> penalty. It remains the accepted Spec 03 record. Under the current baseline (£13,336
> whole-system capex — £890/kWh battery incl. inverter + £1,109/kWp PV — derived 7.42 p/kWh
> pessimistic / 5.56 p/kWh optimistic / 0 p axis) the Glasgow/Agile run-to-fade NPV is
> −£2,186.93 (annual saving £871.48/yr). The full flat / E7 / Agile tariff-axis figures are
> regenerated by the Spec 05 parameter sweep.
