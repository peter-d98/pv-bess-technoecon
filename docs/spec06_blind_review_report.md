...
`.github/specs/spec-06-verification.md`. The reviewer was barred from reading
...
**Scope note:** I did not open `.github/specs/spec-06-verification.md` or `scripts/verify_spec06.py`. All expected values below were derived from `spec-06-sweep-economic-extensions.md` and the source code before comparison. No check is compromised.
